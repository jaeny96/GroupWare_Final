...
public class MypageController {
	...
	public Map<String, Object> modifyEmp(HttpSession session, @RequestBody Employee emp) {
		String id = (String) session.getAttribute("id");
	...
	public Map<String, Object> modifyPwd(HttpSession session, @RequestBody Employee emp) {
		String id = (String) session.getAttribute("id");
	...
	public void profileMapping(@RequestPart MultipartFile profileFile, HttpSession session) {
